...
public class SketchTestDifferentPerson
    ...
    public void setup() {
        ...
        final Persons myPersons = new Persons(Resource.getStream("streifen-person/person.obj"), Resource.getPath("streifen-person/tex/streifen-texture.png"));
    ...
    public static void main(String[] args) {
        ...
        G.init(SketchTestDifferentPerson.class, myDisplayCapabilities);
    }
}
